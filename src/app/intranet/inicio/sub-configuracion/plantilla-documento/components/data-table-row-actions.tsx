...
export function DataTableRowActions<TData>({
  ...
  const handleCopy = async () => {
    const formId = (row.original as any).idplantilladoc
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        <DropdownMenuItem asChild>
          <Link href={`/intranet/inicio/sub-configuracion/formulario/editar-formulario/${(row.original as any).idplantilladoc}`}>
            Editar documento
          </Link> 
        </DropdownMenuItem>
